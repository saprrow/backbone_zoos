...
class InvertedResidual(nn.Module):
    """
    suppose input shape is (512, 512)
    if stride is 2 then  shape is (256, 256)
    if stride is 1 then shape doesn't change
    """
...
class MobileNetV2(nn.Module):
    def __init__(self, output_stride=8, BatchNorm=None, width_mult=1., pretrained=True):
        ...
        self.features = [conv_bn(3, input_channel, 2, BatchNorm)] ## (3, 512, 512) -> (3, 256, 256)
        current_stride *= 2
